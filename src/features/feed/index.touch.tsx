...
const FeedTouchView = ({items}: FeedViewProps) => {
    return (
        <div className={commonStyles.pageShell}>
            <header className={commonStyles.siteHeader}>
                <div className={commonStyles.brandLead}>
                    ...
                    <div>
                        ...
                        <p className={cn('type-meta-sm', commonStyles.tagline)}>
